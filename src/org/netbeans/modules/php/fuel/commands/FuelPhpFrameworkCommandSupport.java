 ...
 * @author junichi11
 */
public class FuelPhpFrameworkCommandSupport extends FrameworkCommandSupport {

    public FuelPhpFrameworkCommandSupport(PhpModule phpModule) {
        super(phpModule);
    }

    @NbBundle.Messages("FuelPhpFrameworkCommandSupport.name=FuelPHP")
    @Override
    public String getFrameworkName() {
        return Bundle.FuelPhpFrameworkCommandSupport_name();
    }
    ...
    public void runCommand(CommandDescriptor commandDescriptor, Runnable postExecution) {
        ...
        try {
            Oil.forPhpModule(phpModule, false).runCommand(phpModule, params, postExecution);
    ...
    protected List<FrameworkCommand> getFrameworkCommandsInternal() {
        try {
            return Oil.forPhpModule(phpModule, true).getCommands(phpModule);
        } catch (InvalidPhpExecutableException ex) {
