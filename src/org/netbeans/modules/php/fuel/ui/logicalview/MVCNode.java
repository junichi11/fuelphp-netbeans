...
public class MVCNode extends FilterNode {
    ...
    private static final String ICON_PATH = "org/netbeans/modules/php/fuel/resources/fuel_icon_8.png"; //NOI18N
    private static final Image FUEL_ICON = ImageUtilities.loadImage(ICON_PATH);
    ...
    public Image getIcon(int type) {
        return ImageUtilities.mergeImages(super.getIcon(type), FUEL_ICON, 7, 7);
    }

    @Override
    public Image getOpenedIcon(int type) {
        return ImageUtilities.mergeImages(super.getOpenedIcon(type), FUEL_ICON, 7, 7);
    }
    ...
    public Action[] getActions(boolean context) {
        ...
        Action customizeAction = CommonProjectActions.customizeProjectAction();
