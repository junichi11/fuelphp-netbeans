...
public class FuelPhpViewGoToStatus extends FuelPhpGoToStatus {

    private static final FuelPhpViewGoToStatus INSTANCE = new FuelPhpViewGoToStatus();

    private FuelPhpViewGoToStatus() {
    }

    public static FuelPhpViewGoToStatus getInstance() {
        return INSTANCE;
    }
    ...
    public List<GoToItem> getControllers() {
        return getControllers(FILE_TYPE.VIEW);
    }
}
